# 01c_program_load_13.tcl — 加载 shell13 内核镜像到 DDR 并保持 CPU 复位
# (比特流已在板上,不重复烧写;如板上无比特流请先跑 01b_program_load_irq.tcl)
...
if {$axi eq ""} { error "hw_axi_1 not found —— 板上是否有 JTAG-AXI 比特流?" }
